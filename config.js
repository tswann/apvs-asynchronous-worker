module.exports = {
  ...
  // Azure Cognitive Services API defaults
  VISION_API_URL: 'https://westus.api.cognitive.microsoft.com/vision/v1.0/',
  VISION_API_SUBSCRIPTION_KEY: process.env.APVS_VISION_API_SUBSCRIPTION_KEY
}
